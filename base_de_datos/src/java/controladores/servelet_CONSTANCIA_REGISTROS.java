 ...
 * @author javie
 */
@WebServlet(name = "servelet_CONSTANCIA_REGISTROS", urlPatterns = {"/servelet_CONSTANCIA_REGISTROS"})
public class servelet_CONSTANCIA_REGISTROS extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if ("consulta".equals(request.getParameter("BConsultar"))) {
            ...
            out.println("<script type=\"text/javascript\">");
                ...
                out.println("<h4 class='modal-title'>Constancia de Registro</h4>");
                out.println("</div>");
                ...
                out.println("<tbody class='text-center'>");
                   ...
                   for (int i = 0; i < Registro.getRowCount(); i++) {
                    ...
                    out.println("<button type='button' onclick=\"location.href='consulta_registro.jsp'\" class='btn btn-default' data-dismiss='modal'>Close</button>");
