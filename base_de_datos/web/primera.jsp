<%-- 
    Document   : primera
    Created on : 22/10/2021, 03:22:21 PM
    Author     : javie
--%>

<%@page import="java.util.HashMap"%>
<%@page import="modelos.dosis"%>
...
<html>
    ...
    <body>
        <div class="container-fluid" style="background-color: #EAF2F8  ;">
            ...
            <div class="card" style="text-align: center; width:  auto; height: 600px; margin: 120px; border-color: #45B39D; background-color: #EAFAF1;">    
                <div class="row">
                    <div class="col-md-12" >
                        <div class="row">
                            <div class="col-md-2">
                            ...
                            <div class="col-md-8">
                                <div class="row">
                                    ...
                                    <div class="col-md-12" style="text-align: center; margin: 20px; ">
                                        ...
                                        <h1>
                                            FORMULARIO DE REGISTRO PARA PRIMERA DOSIS COVID 19
                                        </h1>
                                        ...
                                        <div class="row" style="align-items: center;">
                                            ...
                                            <form action="servelet_primera" method="POST" class="form">
                                                <br>
                                                <br><br>
                                                ...
                                                <br>
                                                <br>
                                                <label> Seleccione su Vacuna:</label><br>
                                                <%
                                                dosis d=new dosis();
                                                HashMap<String,String> listaPrimerDosis=d.Vacunas();
                                                for (String elem : listaPrimerDosis.keySet()) {
                                                        out.println("<input type='radio' name='optradio' value='"+elem+"'>"+listaPrimerDosis.get(elem)+"<br>");
                                                    }
                                                
                                                %>

                                                <br><br>
                                                <button id="btn_agregar" name="btn_agregar" value="agregar" class="btn btn-block btn-outline-info">
                                                    ingresar
                                                </button>
