<%-- 
    Document   : registro
    Created on : 22/10/2021, 02:42:43 PM
    Author     : javie
--%>
                            ...
                            <div class="col-md-8">
                                <div class="row">
                                    ...
                                    <div class="col-md-12" style="text-align: center; margin: 20px; ">
                                        ...
                                        <h1>
                                            FORMULARIO DE REGISTRO PARA VACUNA COVID 19
                                        </h1>
                                        ...
                                        <div class="row" style="align-items: center;">
                                            ...
                                            <form  action="servelet_inscripcion" method="POST">
                                                <br>
                                                <br><br>
                                                ...
                                                <br><br>
                                                <button id="agregar" name="agregar" value="inscribir" class="btn btn-block btn-outline-info">
                                                    ingresar
                                                </button>
