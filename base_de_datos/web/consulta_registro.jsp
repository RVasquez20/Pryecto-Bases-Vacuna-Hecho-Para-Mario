<%-- 
    Document   : consulta_registro
    Created on : 22/10/2021, 03:58:24 PM
    Author     : javie
--%>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12" style="text-align: center; margin: 20px; ">
                                        ...
                                        <div class="row" style="align-items: center;">
                                            ...
                                            <form action="servelet_CONSTANCIA_REGISTROS" method="POST" class="form" role="form">
                                                <br>
                                                <br>
                                                <br><br>
                                                ...
                                                <br><br>
                                                <button  name="BConsultar" id="BConsultar"  value="consulta" class="btn btn-block btn-outline-info">
                                                    Consultar
                                                </button>
