<%-- 
    Document   : segunda
    Created on : 22/10/2021, 03:24:24 PM
    Author     : javie
--%>
                            ...
                            <div class="col-md-8">
                                <div class="row">
                                    ...
                                    <div class="col-md-12" style="text-align: center; margin: 20px; ">
                                        ...
                                        <h1>
                                            FORMULARIO DE REGISTRO PARA SEGUNDA DOSIS COVID 19
                                        </h1>
                                        ...
                                        <div class="row" style="align-items: center;">
                                            ...
                                            <form form action="servelet_segunda" method="POST" class="form">
                                                <br>
                                                <br><br>
